...
class LibraryTest {
    ...
    void addToStockGetsAdded() {
        ...
        LibraryItem item = new Article("Java");
        LibraryItem item2 = new Book("Is");
    ...
    void checkInItemArticleNotOnLoan() {
        Library library = new Library();
        LibraryItem item = new Article("Why inheritance is dope");
        library.addToStock(item);
    ...
    void checkInItemBookNotOnLoan() {
        Library library = new Library();
        LibraryItem item = new Book("Inheritance for beginners");
        library.addToStock(item);
